...
%Power_scaling_rx_x = rms(rx_signal_Filtered_X);
%Power_scaling_rx_y = rms(rx_signal_Filtered_Y);
...
%outputX_Data = outputX.*Power_scaling_rx;
%outputY_Data = outputY.*Power_scaling_rx;

outputX_Data = outputX(N_train+1:end);
outputY_Data = outputY(N_train+1:end);

%outputX_Data = outputX;
%outputY_Data = outputY;
