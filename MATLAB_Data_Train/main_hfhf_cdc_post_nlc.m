...
Tx_Pow_dBm = 2;
    ...
    for loop1 = 1:1:NoLoops
        ...
        rng(Data_rand_seed+loop1*1234);%+7654);
...
%          Rx_SymbolsX_Filt_norm=Rx_SymbolsX_Filt_norm;
%          Rx_SymbolsY_Filt_norm=Rx_SymbolsY_Filt_norm;
         size(Rx_SymbolsX_Total)
         Rx_SymbolsX_CDC=mean(Rx_SymbolsX_Total);
         Rx_SymbolsY_CDC=mean(Rx_SymbolsY_Total);
...
Transmit_image_X_actual=Transmit_image_X;
 ...
 %% Training data
 Training_length = 2^15*8;
 Tx_Bits_X=Tx_BitsX_actual(1:log2(M)*Training_length);
 Tx_Bits_Y=Tx_BitsY_actual(1:log2(M)*Training_length);
 Rx_SymbolsX_Com=Rx_SymbolsX_Com_actual(1:Training_length);
 Rx_SymbolsY_Com=Rx_SymbolsY_Com_actual(1:Training_length);
 Input_Symbol_real_X=Input_Symbol_real_X_actual(1:Training_length);
 Input_Symbol_image_X=Input_Symbol_image_X_actual(1:Training_length);
 Transmit_real_X=Transmit_real_X_actual(1:Training_length);
 Transmit_image_X=Transmit_image_X_actual(1:Training_length);
 fname = "Dataset_16QAM_1000_5WDM32G_PreCDC_train_2.mat";
