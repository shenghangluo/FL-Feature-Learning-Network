function samples_out = RC_RRC_for_FTN(beta, nr_samples,rc_rrc_string,SPS_factor_RRC)
...
tau_vector = (-(nr_samples-1)/2:(nr_samples-1)/2);
switch rc_rrc_string
    case 'normal'
        ...
        if SPS_factor_RRC < 1
            ...
            tau_vector = (-(nr_samples-1)/2:(nr_samples-1)/2)*SPS_factor_RRC;
        end
        % Added later+++
