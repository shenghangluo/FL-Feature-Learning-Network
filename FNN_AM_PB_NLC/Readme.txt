To re-simulate the Learned-AM-PB-NLC
1. Generate IFWM triplets for both training dataset and testing dataset.
	IFWM triplets for training and testing dataset is generated by running the MATLAB file in MATLAB_CODE: FWM_Triplets_Generation
2. Generate Additive and Multiplicative triplets for both training and testing dataset
	Additive and Multiplicative triplets for training and testing dataset is generated by running the MATLAB file in MATLAB_CODE: Triplets_Generation
