...
%% Training data
Tx_BitsX=Tx_BitsX_actual(1:end-(log2(M)*2*N_data));
Tx_BitsY=Tx_BitsY_actual(1:end-(log2(M)*2*N_data));
Rx_SymbolsX_Com=Rx_SymbolsX_Com_actual(1:end-(2*N_data));
Rx_SymbolsY_Com=Rx_SymbolsY_Com_actual(1:end-(2*N_data));
Input_Symbol_real_X=Input_Symbol_real_X_actual(1:end-(2*N_data));
Input_Symbol_image_X=Input_Symbol_image_X_actual(1:end-(2*N_data));
Transmit_real_X=Transmit_real_X_actual(1:end-(2*N_data));
Transmit_image_X=Transmit_image_X_actual(1:end-(2*N_data));

save('G:\MASc\Perturbation_based\learned_A_M_Model\Dataset\Dataset_16QAM_3200_Dual_train_2.mat','Tx_BitsX','Tx_BitsY','Rx_SymbolsX_Com','Rx_SymbolsY_Com', 'Tx_Pow_dBm', 'Input_Symbol_real_X','Input_Symbol_image_X','Transmit_real_X','Transmit_image_X');         
end
